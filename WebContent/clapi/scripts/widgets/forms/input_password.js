 ...
 */
 ...
 function MyQInputPassword(__id, __target, __xml)
 {
	 this.type										= 'TextInput';
	...
	function _renderInput()
	{
		...
		_strInput		= '<input id="'+_id+'" name="'+_id+'" class="inputText" type="password"  value="" style="'+_css+'"/>';
		_strLabel 	= '<div id="label_'+_id+'" style="display: inline; width: 50px;  vertical-align: top; overflow: hidden; font-size: 11px">' +_evaluate(_me, _getProperty('label'),true) + '&nbsp;</div>';
		...
		if(_featFloat==true) _body.style.float			= 'left';
